//Saving this code here because im lowkey proud of the grouping/overlays logic.. it did exactly what i wanted, looked good, but lacked performance (entirely lol) so i decided to go a different route in the production app
